...
export default function LandingPage() {
  ...
  <div id="menu" data-section="menu">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$7",
          variant: "Dessert",
          imageSrc: "http://img.b2bpic.net/free-photo/slice-blueberry-cheesecake_1232-2701.jpg",
        },
        {
          id: "p4",
          ...
          price: "$9",
          variant: "Healthy",
          imageSrc: "http://img.b2bpic.net/free-photo/closeup-lemonade-chocolate-cake-female-hands_169016-38991.jpg",
        },
        {
          id: "p5",
          name: "Crispy Fries",
          price: "$5",
          variant: "Appetizer",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-delicious-little-cake-with-chocolate-bars-sweet-crackers-white-background-cracker-sweet-biscuit-cake-pie-tea_140725-116273.jpg",
        },
        {
          id: "p6",
      ...
      features={[
        {
          ...
          description: "Custom decor packages for your special day.",
          icon: Gift,
          mediaItems: [
            {
              imageSrc: "http://img.b2bpic.net/free-photo/high-angle-cotillion-arrangement_23-2149298537.jpg",
            },
            {
        ...
        },
        {
          ...
          description: "Join our weekly creative sessions.",
          icon: Palette,
          mediaItems: [
            {
        ...
        {
          title: "Cozy Hangouts",
          description: "Perfect nooks for gaming or studying.",
          icon: Coffee,
          mediaItems: [
            {
  ...
  <div id="about" data-section="about">
      ...
      title="Our Story"
      description={[
        "Founded on a love for community and creative expression, La Casa is where local art meets artisanal baking.",
        "We believe every guest deserves a memory to take home.",
      ]}
    />
  </div>
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/medium-shot-man-painting-indoors_23-2150182597.jpg",
          alt: "John",
        },
        {
          src: "http://img.b2bpic.net/free-photo/couple-browsing-smartphones-date_23-2147744393.jpg",
          alt: "Emily",
        },
        {
          src: "http://img.b2bpic.net/free-photo/father-spending-time-together-with-his-girl-outdoors_23-2149032217.jpg",
          alt: "Mark",
        },
        {
          src: "http://img.b2bpic.net/free-photo/young-beautiful-hispanic-woman-artist-smiling-confident-holding-paintbrush-palette-art-studio_839833-25796.jpg",
          alt: "Alex",
        },
      ]}
      ...
      faqs={[
        {
          ...
          content: "Yes, we provide custom decorations and seating for all group sizes.",
        },
        {
          id: "2",
          title: "Do you need a reservation?",
          content: "Walk-ins are welcome, but booking ahead ensures your spot for events.",
        },
        {
          id: "3",
          title: "Is your space pet-friendly?",
          content: "Yes, our outdoor seating area is happy to welcome your furry friends.",
        },
      ]}
